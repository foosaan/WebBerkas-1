...
@section('content')
    <div class="container">
        ...
        <ul class="nav nav-tabs" id="layananTabs" role="tablist">
            @if($divisi === 'VERA')
                <li class="nav-item"><a class="nav-link active" id="vera-tab" data-toggle="tab" href="#vera" role="tab">Layanan
                        Vera</a></li>
            @elseif($divisi === 'PD')
                <li class="nav-item"><a class="nav-link active" id="pd-tab" data-toggle="tab" href="#pd" role="tab">Layanan
                        PD</a></li>
            @elseif($divisi === 'MSKI')
                <li class="nav-item"><a class="nav-link active" id="mski-tab" data-toggle="tab" href="#mski" role="tab">Layanan
                        MSKI</a></li>
            @elseif($divisi === 'BANK')
                <li class="nav-item"><a class="nav-link active" id="bank-tab" data-toggle="tab" href="#bank" role="tab">Layanan
                        Bank</a></li>
            @endif
            @if($divisi === 'UMUM')
                <li class="nav-item"><a class="nav-link active" id="umum-tab" data-toggle="tab" href="#umum" role="tab">Layanan
                        Umum</a></li>
            @endif
        </ul>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="8" class="text-center">Tidak ada data layanan Umum</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>

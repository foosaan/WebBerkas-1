                ...
                <table class="table table-striped" id="tableSemua">
                    ...
                    <tbody>
                        @php
                            ...
                            $allRequests = collect();
                            if($divisi==='VERA') $allRequests = $veraRequests;
                            if($divisi==='PD') $allRequests = $pdRequests;
                            if($divisi==='MSKI') $allRequests = $mskiRequests;
                            if($divisi==='BANK') $allRequests = $bankRequests;
                        @endphp
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('staff.updateStatus', [$request->id, $request->layanan_type]) }}" method="POST">
                                    @csrf
                                    @method('PUT')

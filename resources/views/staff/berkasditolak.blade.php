...
@section('content')
    <div class="container">
        ...
        <ul class="nav nav-tabs" id="layananTabs" role="tablist">
            ...
            @endif
            @if($divisi === 'UMUM')
                <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#umum" role="tab">Layanan Umum</a></li>
            @endif
        </ul>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="9" class="text-center">Tidak ada data layanan PD</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="9" class="text-center">Tidak ada data layanan MSKI</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="9" class="text-center">Tidak ada data layanan Bank</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
